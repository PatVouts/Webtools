...
{
    public class CondensingUnitPricingTranslation
    {
        public static void translateReport(CondensingUnitPricing report, string language)
        {
            ...
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.Section3.ReportObjects["txtMainVoltage"]).Text = language == "EN" ? "Main Voltage" : "Voltage principal";
