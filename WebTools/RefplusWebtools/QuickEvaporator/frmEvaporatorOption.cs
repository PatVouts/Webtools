...
{
    public partial class FrmEvaporatorOption : Form
    {
        ...
        public FrmEvaporatorOption(bool openQuote, string evaporatorType, string style, string defrostType, decimal capacity, string voltageID, DataSet dsQuoteData, int intIndex)
        {
        ...
        public FrmEvaporatorOption(bool openQuote, string evaporatorType, string style, string defrostType, decimal capacity, string voltageID)
        {
            FormConstructor(openQuote, evaporatorType, style, defrostType, capacity, voltageID);
        }
        ...
        private void frmEvaporatorOption_Load(object sender, EventArgs e)
        {
        ...
        {
            _dtOptionList = Public.SelectAndSortTable(Public.DSDatabase.Tables["EvaporatorOptions"], "Serie LIKE '%" + _evaporatorType + _style + _defrostType + "%' AND MinCapacity <= " + _capacity + " AND MaxCapacity >= " + _capacity + " AND Voltage LIKE '%" + _voltageID + "%' AND IsRefrigerant = 1", "GroupName, Description");
        }
        ...
        {
            DataTable dtOptions = Public.SelectAndSortTable(_dsQuoteData.Tables["EvaporatorOption"], "ItemID = " + _intIndex, "");
        ...
        {
            GetOptionInput = Tables.DtEvaporatorOptions();
