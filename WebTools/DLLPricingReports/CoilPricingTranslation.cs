...
{
    public class CoilPricingTranslation
    {
        public static void translateReport(CoilPricing report, string language)
        {   
            ...
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.DetailSection2.ReportObjects["txtTubulator"]).Text = language == "EN" ? "Turbulator" : "Turbulateur";
            ...
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.Section5.ReportObjects["Text1"]).Text = language == "EN" ? "Freight Extra." : "Frais de transport supplémentaires.";
