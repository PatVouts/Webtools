...
{
    public partial class FrmAddEvapOption : Form
    {
        ...
        public FrmAddEvapOption(FrmAdditionalItems frmParentForm)
        {
            InitializeComponent();
            _frmParentForm = frmParentForm;
        }

        private void frmAddEvapOption_Load(object sender, EventArgs e)
        {
        ...
        private void FillListOfOptions()
        {
            ...
            DataTable dtCUOptions = Public.SelectAndSortTable(Public.DSDatabase.Tables["EvaporatorOptions"], "", "GroupName, Description, Price");
