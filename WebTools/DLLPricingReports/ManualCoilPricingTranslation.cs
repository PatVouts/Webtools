...
{
    public class ManualCoilPricingTranslation
    {
        public static void translateReport(ManualCoilPricing report, string language)
        {
            ...
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.Section3.ReportObjects["txtCasingMaterial"]).Text = language == "EN" ? "Casing Material" : "Matériel du Boitier";
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.Section3.ReportObjects["txtHeaderDiameter"]).Text = language == "EN" ? "Header Diameter" : "Diamètre de collecteur";
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.Section3.ReportObjects["txtConnectionSide"]).Text = language == "EN" ? "Connection Side" : "Côté de raccordement";
            ((CrystalDecisions.CrystalReports.Engine.TextObject)report.Section3.ReportObjects["txtSampleCoil"]).Text = language == "EN" ? "As per Coil Sample" : "Tel qu’échantillon";
